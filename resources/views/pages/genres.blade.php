@extends('layouts.app')
@section('title') GENRES - BOOKLE @endsection
            ...
            //  =========== Use Option =========
               ...
               $('#statusSelect').on('change', function() {
                  ...
                  if (selectedOption === 'deleteSelected') {
                        ...
                        $.ajax({
                           url: "{{ route('genres.deleteSelected') }}", // Laravel route for deleting roles
                           method: 'POST',
                           data: {
                ...
                $('#btnmodal').click(function(){
                 ...
                 $('#formSave').on('submit', function(e){
                    ...
                    var name_kh = $('#name_kh').val();
                     ...
                     $.ajax({
                     url: "{{ route('genres.store') }}", // Your Laravel route to handle the form submission
                     method: "POST",
                     data: {
                 ...
                 //  end Store
                  ...
                  $('#dataTable').on('click', '.btnEdit', function(){
                    ...
                    $('#btnUpdate').click(function(){
                        ...
                        $.ajax({
                            url: "{{ route('genres.update') }}", // Your Laravel route to handle the form submission
                            method: "PUT",
                            data: {
                                _token: "{{ csrf_token() }}", // CSRF Token for security
                                id: id,
                  ...
                  $('#dataTable').on('click', '.btnDelete',function(){
                    ...
                    if(con == true){
                        $.ajax({
                            url: "{{ route('genres.delete') }}", // Your Laravel route to handle the form submission
                            method: "Delete",
                            data: {
                                _token: "{{ csrf_token() }}", // CSRF Token for security
                                id: id,
